...
class LSqEllipse:
    ...
    def fit(self, data):
        ...
        """
        # 弄一个栈吧 然后for循环 这样能实现continue 当cond<0时候能返回
        ...
        # reference:https://blog.csdn.net/liucc09/article/details/82763635
        ...
        #M*|a b c >=l|a b c >. Find eigenvalues(特征值) and eigenvectors(特征向量) from this equation [eqn. 28]
    ...
    def _save_parameters(self):
        ...
        # TODO:有些denominator1 denominator2 numerator小于零
        # if denominator1>0 and denominator2>0 and numerator>0:
